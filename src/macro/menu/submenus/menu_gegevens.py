...
menu_gegevens.toevoegen_optie(menu_hoofdcategorie, "hoofdcategorieën product")
...
menu_hoofdcategorie.toevoegen_optie(Hoofdcategorie.bewerken, "bewerken hoofdcategorie product")
menu_hoofdcategorie.toevoegen_optie(Hoofdcategorie.inspecteren, "inspecteren hoofdcategorie product")
...
menu_categorie.toevoegen_optie(Categorie.bewerken, "bewerken categorie product")
menu_categorie.toevoegen_optie(Categorie.inspecteren, "inspecteren categorie product")
...
menu_hoofdcategorie_gerecht.toevoegen_optie(HoofdcategorieGerecht.inspecteren, "inspecteren hoofdcategorie gerecht")
...
menu_categorie_gerecht.toevoegen_optie(CategorieGerecht.inspecteren, "inspecteren categorie gerecht")
